...
$GUIArgs = "-Title `"$Title`" -Text `"$Text`" -Button1Text `"$Button1Text`" -Button1ExitCode $Button1ExitCode -Button2Text `"$Button2Text`" -Button2ExitCode $Button2ExitCode -CountDownTime $CountDownTime"
...
[UserContext.ProcessExtensions.ProcessExtensions]::StartProcessAsCurrentUser("$PSScriptRoot\SimplePowershellGUI.exe", "$GUIArgs")